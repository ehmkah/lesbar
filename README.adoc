...
http://binnenibegone.awardspace.com/ - Habe ich leider erst später gefunden.
Ersetzt automatisch die gendergerechte Sprache. Etwas komplexer.

# Development

Je nach Browser siehe `chrome/README.adoc` und `firefox/README.adoc`.
